//treinamento - aprende com o script e aplica nos controles
import utils from './utils.js';
import RNA from './RNA.js';
import controls from './controls.js';

//quantos samples (agentes) queremos colocar por geração
const SAMPLES = 20;
...
setInterval(() => {
  ...
  if(obstacle) {
    ...
    if(jump === crouch) {
      ...
      controls.dispatch('jump'); // se verdadeira, o dino pula
    } else if (crouch) {
      controls.dispatch('crouch'); // se verdadeira, o dino agacha
    }
  };
}, 100);

/* ativação pelo console
const s = document.creatElement('script');
s.type = 'module';
